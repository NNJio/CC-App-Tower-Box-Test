...
import 'package:cc_app_tower_box_test/scr/constant/app_colors.dart';
import 'package:cc_app_tower_box_test/scr/widgets/button.dart';
import 'package:cc_app_tower_box_test/scr/widgets/triangle.dart';
            ...
            return Padding(
              ...
              child: !data['status']
                  ? Row(
                      ...
                      children: [
                        if (provider.currentLevel == i) const Triangle(),
                        Padding(
                          ...
                          child: RotationTransition(
                            turns: AlwaysStoppedAnimation(
                                data['color'] == 'purple' ? 45 / 360 : 0 / 360),
                            child: Container(
                                width: orientation == Orientation.portrait
                                    ? size.width * 0.3
                                    : (size.width * 0.675) * 0.3,
                                height: data['color'] == 'purple'
                                    ? orientation == Orientation.portrait
                                        ? size.width * 0.3
                                        : (size.width * 0.675) * 0.3
                                    : orientation == Orientation.portrait
